...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // 2. Asegurar que el copyright esté visible y completamente fijo
  ...
  if (legalNotice) {
    ...
    console.log('✅ Copyright activado y fijado');
  }
  ...
  if (sidebarFooter) {
    ...
    sidebarFooter.style.backgroundColor = '#1a2332';
...
function forceFooterFixed() {
  ...
  if (sidebarFooter && !sidebar.classList.contains('collapsed')) {
    ...
    sidebarFooter.style.setProperty('height', '80px', 'important');
    sidebarFooter.style.setProperty('max-height', '80px', 'important');
    sidebarFooter.style.setProperty('min-height', '60px', 'important');
    sidebarFooter.style.setProperty('background-color', '#1a2332', 'important');
    ...
    sidebarFooter.style.setProperty('padding', '0.5rem 0.8rem 1rem 0.8rem', 'important');
    sidebarFooter.style.setProperty('flex-shrink', '0', 'important');
  }
  
  if (legalNotice) {
    // Forzar visibilidad del copyright
